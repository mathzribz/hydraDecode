...
public class red_12 extends OpMode {
    ...
    public void Paths() {
        ...
        Path2 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(93.000, 93.000),
                                new Pose(92.178, 73.139),
                                new Pose(69.855, 55.713),
                                new Pose(126.469, 58.811)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
        ...
        PathD = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(126.469, 58.811),
                                new Pose(122.766, 64.873),
                                new Pose(128.839, 72.054)
                        )
        ...
        Path4 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(93.000, 93.000),
                                new Pose(75.647, 31.209),
                                new Pose(129.758, 35.418)
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(0))
        ...
        Path6 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(93.000, 93.000),
                                new Pose(85.719, 81.024),
                                new Pose(130.305, 84.505)
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(0))
    ...
    public void init() {
        ...
        Paths();
        follower.setStartingPose(new Pose(33.118279569892465, 135.31182795698925, Math.toRadians(0)));
