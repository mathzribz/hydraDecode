...
@Config
@TeleOp
public class engaja_maldito_blue extends CommandOpMode {
    ...
    Pose startPos = new Pose(18, 120, 145);


    private final Pose scorePose = new Pose(43.5, 100, Math.toRadians(135));
    private final Pose repoPose1 = new Pose(59, 86 , Math.toRadians(0));
