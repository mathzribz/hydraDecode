...
public class Drivetrain {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        // Control HUb
        topLeftDriveMotor = hwMap.get(DcMotor.class, "LMF");
        bottomLeftDriveMotor = hwMap.get(DcMotor.class, "LMB");
        topRightDriveMotor = hwMap.get(DcMotor.class, "LMF");
        bottomRightDriveMotor = hwMap.get(DcMotor.class, "LMB");
